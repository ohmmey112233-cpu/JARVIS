...
### [ ] 5.2 ⚠️ ตรวจว่าบรรทัด 🚗 มีประโยชน์จริงไหม

พิกัดกรอกครบแล้วทั้ง 3 จุด **แต่มีเรื่องต้องเคลียร์**:

พิกัดหอกับโรงเรียนที่ให้มา **ห่างกันแค่ 165 เมตร** (เดิน 2 นาที) แต่ phase1-kit
เขียนตัวอย่างไว้ว่าใช้เวลา 11-15 นาที — ขัดกันเอง

- [ ] เปิด Google Maps วัดจากหอไปโรงเรียนเองแล้วดูว่าได้กี่นาที

| ผลที่วัดได้ | แปลว่า | ต้องทำอะไร |
|---|---|---|
| ~2 นาที | หอติดโรงเรียนจริง ตัวเลขใน kit เป็นตัวอย่างสมมติ | บรรทัด 🚗 แทบไม่มีประโยชน์ — บอกมา จะตัดออกหรือเปลี่ยนเป็นอย่างอื่น |
| 11-15 นาที | พิกัดผิด (มงฟอร์ตมีหลายแผนก) | ส่งพิกัดที่ถูกมาใหม่ |

ยังไม่ต้องแก้อะไรตอนนี้ ระบบทำงานได้ทั้งสองแบบ — แค่บรรทัด 🚗 จะน่าเบื่อถ้าเป็นแบบแรก
